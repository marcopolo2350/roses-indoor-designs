...
function buildStarterFurniture(starter, w, l) {
  ...
  const sets = {
    living_room: [
      ...
      { label: "Palm Plant", assetKey: "plant_palm", x: 1.6, y: 2, w: 1.4, d: 1.4, rotation: 0 },
      {
        label: "Wall Art",
    ...
    dining_room: [
      ...
      { label: "Bench", assetKey: "bench", x: midX, y: midY - 2.4, w: 3.5, d: 1.4, rotation: 180 },
      {
        label: "Pendant Light",
    ...
    studio: [
      ...
      { label: "Palm Plant", assetKey: "plant_palm", x: 1.6, y: 1.6, w: 1.4, d: 1.4, rotation: 0 },
      {
        label: "Floor Lamp",
        assetKey: "lamp_floor",
        x: w - 1.5,
