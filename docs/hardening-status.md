...
- Generated property-panel HTML still uses inline event handlers in selected-vertex, selected-opening, selected-structure, and selected-annotation panels.
