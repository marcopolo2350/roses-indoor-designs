...
- Inline handlers are removed from the static app shell, generated catalog picker, Home Plan controls, Add Room controls, and Surfaces controls, but generated property-panel markup still contains inline handlers in legacy editor surfaces.
...
- Generated property-panel HTML still uses inline event handlers outside the catalog picker, Home Plan, Add Room, and Surfaces controls.
