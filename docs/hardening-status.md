...
Current app version: `0.5.0-hardening.55`
...
- Package, app shell, runtime config, changelog, and hardening-status versions are guarded by `npm run validate:version`.
