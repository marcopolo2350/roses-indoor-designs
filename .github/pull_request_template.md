...
- [ ] preserves existing app behavior unless intentionally called out
- [ ] does not add new product modes or speculative features
- [ ] documents any deferred debt honestly
...
- any intentional debt or follow-up called out
